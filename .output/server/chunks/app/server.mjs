...
const _routes = [
  {
    ...
    alias: [],
    redirect: void 0,
    component: () => import('./_nuxt/about-c88ac465.mjs').then((m) => m.default || m)
  },
  {
    name: "contact",
    path: "/contact",
    ...
    alias: [],
    redirect: void 0,
    component: () => import('./_nuxt/contact-e43f3824.mjs').then((m) => m.default || m)
  },
  {
    name: "index",
    path: "/",
    ...
    alias: [],
    redirect: void 0,
    component: () => import('./_nuxt/index-ce625bb6.mjs').then((m) => m.default || m)
  }
];
...
const layouts = {
  default: () => import('./_nuxt/default-72e7fa2e.mjs').then((m) => m.default || m)
};
...
const _sfc_main$1 = {
  ...
  setup(__props) {
    ...
    const stack = void 0;
    const _Error404 = /* @__PURE__ */ defineAsyncComponent(() => import('./_nuxt/error-404-aa274f42.mjs').then((r) => r.default || r));
